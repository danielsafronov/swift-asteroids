...
/// AsteroidRepository structure.
struct AsteroidRepository: AsteroidRepositoryProtocol {
    /// An instance of AsteroidDataSourceProtocol.
    let dataSource: AsteroidDataSourceProtocol
